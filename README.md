...
\- Sends the result via email (scheduled externally; I'm using GitHub Actions but you might use a different option)



FYI:

Secrets (email password, OpenAI API key) are provided via Actions so they are not in the repo. 
